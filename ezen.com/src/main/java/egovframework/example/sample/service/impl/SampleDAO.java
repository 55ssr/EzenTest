...
public class SampleDAO extends EgovAbstractDAO {
	...
	public List<?> selectDeptList(SampleDefaultVO searchVO) {
		return list("sampleDAO.selectDeptList", searchVO);
	}
	...
	public DeptVO selectDeptDetail(DeptVO vo) {
		return (DeptVO) select("sampleDAO.selectDeptDetail", vo);
	}

	public void updateDept(DeptVO vo) {
		update("sampleDAO.updateDept", vo);
	}

	public void deleteDept(DeptVO vo) {
		delete("sampleDAO.deleteDept", vo);
	}

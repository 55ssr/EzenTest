    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_select(id) {
        	document.listForm.selectedId.value = id;
           	document.listForm.action = "<c:url value='/boardDetail.do'/>";
        ...
        function fn_egov_selectList() {
        	document.listForm.action = "<c:url value='/boardList2.do'/>";
           	document.listForm.submit();
        }
        ...
        <div id="content_pop">
        		...
        		<table width="100%" border="0" cellpadding="0" cellspacing="0" summary="카테고리ID, 케테고리명, 사용여부, Description, 등록자 표시하는 테이블">
        			...
        			<c:forEach var="result" items="${resultList}" varStatus="status">
            			<tr>
            				...
            				<td align="center" class="listtd"><a href="javascript:fn_egov_select('<c:out value="${result.unq}"/>')"><c:out value="${result.title}"/></a></td>
        	...
        	<div id="sysbtn">
        	  <ul>
        	      <li>
        	          <span class="btn_blue_l">
        	              <a href="javascript:fn_egov_addView();"><spring:message code="ezen.create" /></a>
                          <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                      </span>
                  </li>
              </ul>

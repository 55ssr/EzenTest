...
public class EgovSampleServiceImpl extends EgovAbstractServiceImpl implements EgovSampleService {
	...
	@Override
	public List<?> selectDeptList(SampleDefaultVO searchVO) throws Exception {
		return sampleDAO.selectDeptList(searchVO);
	}
